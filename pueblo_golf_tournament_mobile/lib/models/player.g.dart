...
Player _$PlayerFromJson(Map<String, dynamic> json) => Player(
      ...
      id: json['id'] as int,
      playerType: $enumDecode(_$PlayerTypeEnumEnumMap, json['playerType']),
...
Map<String, dynamic> _$PlayerToJson(Player instance) => <String, dynamic>{
      'id': instance.id,
      'playerType': _$PlayerTypeEnumEnumMap[instance.playerType]!,
...
const _$PlayerTypeEnumEnumMap = {
  PlayerTypeEnum.Captain: 'Captain',
  PlayerTypeEnum.Member: 'Member',
};
